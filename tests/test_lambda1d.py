from lambda_layers import LambdaNetwork1DConv
...
class LambdaNetwork1DConvTest(tf.test.TestCase):
    ...
    def testLambdaNetwork1DWithConv(self):
        ...
        layers_1_test = LambdaNetwork1DConv(
    ...
    def testLambdaNetwork1DWihEmb(self):
        ...
        # init layer with embedding
        layers_2_test = LambdaNetwork1DConv(
            kernel_out=kernel_out,
            key_depth=key_depth,
            intra_depth=intra_depth,
            heads=heads,
